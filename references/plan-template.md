...
- The agent never merges by default; PR is for user review. Opt-in paths are merge-commit-on-green or the reviewed-PR landing command, both after the final readiness review.
